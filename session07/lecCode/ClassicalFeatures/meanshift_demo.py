...
class MeanShiftTracker:
    ...
    def init_tracking(self, frame, bbox):
        ...
        self.roi_hist = cv2.calcHist([hsv_roi], [0], mask, [self.hist_bins], [0, 180])
    ...
    def track(self, frame):
        ...
        if self.use_camshift:
            ...
            cv2.arrowedLine(
                vis_frame, center, (center[0] + dx, center[1] + dy), (255, 0, 0), 2
            )
...
def select_roi_interactive(frame):
    ...
    bbox = cv2.selectROI(
        "Select Object to Track", frame, fromCenter=False, showCrosshair=True
    )
...
def main():
    ...
    parser.add_argument(
        "--bins", type=int, default=16, help="Number of histogram bins (default: 16)"
    )
    parser.add_argument(
